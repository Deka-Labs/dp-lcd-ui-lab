...
#define KEYBOARD_COL_0_Pin GPIO_PIN_0
#define KEYBOARD_COL_0_GPIO_Port GPIOC
#define KEYBOARD_COL_0_EXTI_IRQn EXTI0_IRQn
#define KEYBOARD_COL_1_Pin GPIO_PIN_1
#define KEYBOARD_COL_1_GPIO_Port GPIOC
#define KEYBOARD_COL_1_EXTI_IRQn EXTI1_IRQn
#define KEYBOARD_COL_2_Pin GPIO_PIN_2
#define KEYBOARD_COL_2_GPIO_Port GPIOC
#define KEYBOARD_COL_2_EXTI_IRQn EXTI2_TSC_IRQn
#define KEYBOARD_COL_3_Pin GPIO_PIN_3
#define KEYBOARD_COL_3_GPIO_Port GPIOC
#define KEYBOARD_COL_3_EXTI_IRQn EXTI3_IRQn
...
#define KEYBOARD_LINE_0_Pin GPIO_PIN_4
#define KEYBOARD_LINE_0_GPIO_Port GPIOC
#define KEYBOARD_LINE_1_Pin GPIO_PIN_5
#define KEYBOARD_LINE_1_GPIO_Port GPIOC
...
#define KEYBOARD_LINE_2_Pin GPIO_PIN_6
